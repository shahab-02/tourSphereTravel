...
function Footer() {
  return (
      <footer className='w-full bg-[#161616] font-montserrat'>
      <div className="flex justify-between  flex-col lg:flex-row lg:flex-1 h-full text-white p-6 lg:pt-16">
        ...
        <div className='lg:pr-10'>
          ...
          <div className='pt-4 flex font-poppins'>
            <input type="text" placeholder='you@company.com' className='bg-[#313131]  px-4 py-2 lg:px-6 lg:py-4 font-medium  w-full placeholder:text-xs lg:placeholder:text-lg' />
            <a href="#"><button className='bg-[#E9584B] px-4 py-4 lg:px-6 lg:py-4 font-medium opacity-60  text-xs lg:text-lg w-full '>SUBSCRIBE</button></a>
          </div>
