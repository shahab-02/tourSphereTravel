...
function Card({country, Image}) {
  return (
    <div className='shadow-lg shadow-gray-300 w-40 lg:w-50 xl:w-60 mt-12 font-montserrat'>
      <div>
        ...
        7 days / 6 nights</p>
        <div className='flex justify-center'><div className='mt-3 border w-64 rounded-full border-[#00000021]'></div></div>
