...
function Card({country, Image}) {
  return (
    <div className='shadow-lg shadow-gray-300 mb-8 w-70 mt-12 font-montserrat'>
      <div>
        <img src={Image} className='object-cover'   />
        <h1 className='font-semibold p-3 truncate'>{country}</h1>
        <p className=' pl-3 text-sm text-[#667085] flex'><img src={TimeCircle} className='h-4 pr-1' />
        7 days / 6 nights</p>
        <div className='flex justify-center'><div className='mt-3 border-1 w-60 mx-3 rounded-full border-[#00000021]'></div></div>
